...
export class ModelTargetMapper implements IModelTargetMapper {
  ...
  toArray(fillEmpty: boolean = false): number[] {
    if (fillEmpty) {
      return [
        this.muscular,
        this.bodyFat,
        ...
        this.male,
        this.female,
        this.neckIndicatorDisable ?? 1,
        this.shoulderIndicatorDisable ?? 1,
        this.backLengthIndicatorDisable ?? 1,
        this.bustIndicatorDisable ?? 1,
        this.underBustIndicatorDisable ?? 1,
        this.waistIndicatorDisable ?? 1,
        this.hipIndicatorDisable ?? 1,
        this.thighIndicatorDisable ?? 1,
        this.calfIndicatorDisable ?? 1,
        this.upperArmIndicatorDisable ?? 1,
        this.foreArmIndicatorDisable ?? 1,
        this.outerArmLengthIndicatorDisable ?? 1,
        this.sleeveLengthIndicatorDisable ?? 1,
        this.insideLegHeightIndicatorDisable ?? 1,
        this.outsideLegHeightIndicatorDisable ?? 1,
        this.backNeckHeightIndicatorDisable ?? 1,
      ];
    }
    return [
      this.muscular,
